...
export default function ContactForm() {
  ...
  return (
    <div className="flex bg-black text-white p-[100px]">
      <div className="w-1/2 pr-8">
        <h1 className="text-4xl font-bold mb-4">Let's Work <span className="text-[#b69942] ">together</span></h1>
        <p className="mb-4">Do you want to work with me or directly learn from me?</p>
        <p className="mb-4">You can send an email or fill the form</p>
       ...
       <Phone className='mr-2 text-[#b69942] ' />
        ...
        <img src={watch} alt="Smart watch" className="mt-8" />
      </div>
      <div className="w-1/2">
